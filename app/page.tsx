        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid items-center gap-14 lg:grid-cols-[1.1fr_0.9fr] lg:gap-20">
            ...
            >
              ...
              >
                {/* Cyan Line */}
                <div className="h-px w-10 shrink-0 bg-cyan-500" />

                {/* Role Container */}
                <div className="relative h-9 min-w-0 overflow-hidden md:h-10">
                  <motion.p
                    key={roles[roleIndex]}
                    initial={{
                      opacity: 0,
                    ...
                    className="text-xl font-semibold text-slate-700 dark:text-slate-200 md:text-2xl"
                  >
                    {roles[roleIndex]}
                  </motion.p>
                </div>
